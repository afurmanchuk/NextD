...
select en.PROVIDERID
      ,en.NPI
      ,en.NPI_analogue /*KUMC specific use; follow directions on insert A1 (end of this file) if you are not KUMC*/
      ,nm.TAXONOMY
...
due to extreme size of registry I suggest to 
(i) collect complete list of NPI codes for the site; 
(ii) map those into Taxonomy codes and save them localy; 
(iii) use this subset for all extraction codes utilizing NPI information.
After completing mapping from NPI into taxonomy codes the following mapping into NPI_analogue could be used:

case when b.[Taxonomy code] is not NULL and b.[Taxonomy code] in ('102X00000X','171R00000X','172A00000X','247ZC0005X','367A00000X','374K00000X','374T00000X','376G00000X','390200000X') then '0'
			when b.[Taxonomy code] is not NULL and b.[Taxonomy code] in ('202C00000X','202K00000X','204C00000X','204D00000X','204E00000X','204F00000X','204R00000X','207K00000X','207KA0200X','207KI0005X','207L00000X','207LA0401X','207LC0200X',
			...
			when b.[Taxonomy code] is not NULL and b.[Taxonomy code] in ('363L00000X','363LA2100X','363LA2200X','363LC0200X','363LC1500X','363LF0000X','363LG0600X','363LN0000X','363LN0005X','363LP0200X','363LP0222X',
			...
			when b.[Taxonomy code] is not NULL and b.[Taxonomy code] in ('101Y00000X','101YA0400X','101YM0800X','101YP1600X','101YP2500X','101YS0200X','102L00000X','103G00000X','103GC0700X','103K00000X','103T00000X','103TA0400X','103TA0700X',
