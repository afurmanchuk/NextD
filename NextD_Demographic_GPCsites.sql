...
select PATID,'|' as Pipe1,BIRTH_YEAR,'|' as Pipe1,BIRTH_MONTH,'|' as Pipe1,BIRTH_DELTA_DAYS,'|' as Pipe1,SEX,'|' as Pipe1,RACE,'|' as Pipe1,HISPANIC,'|' as Pipe1 ,PAT_PREF_LANGUAGE_SPOKEN,'|' as Pipe1 MARITAL_STATUS,'ENDALONAEND' as ENDOFLINE
