...
select c.PATID,'|' as Pipe,1
		...
		datediff(dd,c.[FirstVisit],a.ADMIT_DATE) as DAYS_from_FirstEncounter_Date1,'|' as Pipe6,
		year(a.DISCHARGE_DATE) as DISCHARGE_DATE_YEAR,'|' as Pipe7,
		month(a.DISCHARGE_DATE) as DISCHARGE_DATE_MONTH,'|' as Pipe8,
		datediff(dd,c.[FirstVisit],a.DISCHARGE_DATE) as DAYS_from_FirstEncounter_Date2,'|' as Pipe9,
